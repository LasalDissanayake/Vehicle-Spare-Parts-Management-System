...
<body>
    <header>
        <nav class="navbar navbar-expand-md navbar-dark" style="background-color: #333333">
            ...
            <ul class="navbar-nav">
                <li><a href="<%=request.getContextPath()%>/list_product" class="nav-link">Products</a></li>
            </ul>
        </nav>
    </header>
            ...
            <div class="col-md-2">
                <div class="sidebar">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="<%=request.getContextPath()%>/list_product">Products</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="main-content">
                        ...
                        <div class="container">
                            ...
                            <div class="container text-left">
                                <a href="<%=request.getContextPath()%>/newProduct" class="btn btn-success">Add New Product</a>
                            </div>
                            <br>
                                    ...
                                    <tbody>
                                        <c:forEach var="Product" items="${listProducts}">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<%=request.getContextPath()%>/editProduct?productID=<c:out value='${Product.productID}' />" class="btn btn-primary">Edit</a>
                                                    <a href="<%=request.getContextPath()%>/deleteProduct?productID=<c:out value='${Product.productID}' />" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
