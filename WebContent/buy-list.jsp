                                    ...
                                    <tbody>
                                        <c:forEach var="Cart" items="${listCartUser}">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<%=request.getContextPath()%>/editCartUser?cartID=<c:out value='${Cart.cartID}' />" class="btn btn-primary">Edit</a>
                                                    <a href="<%=request.getContextPath()%>/deleteCartUser?cartID=<c:out value='${Cart.cartID}' />" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
